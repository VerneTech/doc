...
![Fortinet]({{ site.baseurl }}/ciber/newsletter/img/4/2025-4-img6.png){: .css-imagen}
...
**conclusión**
El actor malicioso ha utilizado datos antiguos para crear la impresión de una nueva filtración. **La mayoría de los dispositivos afectados ya han sido actualizados a versiones más recientes de FortiOS, lo que reduce significativamente el riesgo para las organizaciones que han seguido las prácticas recomendadas.** Fortinet asegura que los dispositivos adquiridos desde diciembre de 2022 o que ejecuten FortiOS 7.2.2 o superior no están afectados por esta divulgación.

![Fortinet PSIRT]({{ site.baseurl }}/ciber/newsletter/img/4/fig03-psirt-threat-actor-data-posting.jpeg){: .css-imagen}
...
![TikTok]({{ site.baseurl }}/ciber/newsletter/img/4/2025-4-img1.png){: .css-imagen}
...
![2FA Phishing]({{ site.baseurl }}/ciber/newsletter/img/4/2025-4-img2.png){: .css-imagen}
...
![Seguridad en la nube]({{ site.baseurl }}/ciber/newsletter/img/4/2025-4-img3.png){: .css-imagen}
...
![Gestión de Exposición]({{ site.baseurl }}/ciber/newsletter/img/4/2025-4-img4.png){: .css-imagen}
...
![Windows Server]({{ site.baseurl }}/ciber/newsletter/img/4/2025-4-img7.png){: .css-imagen}
